...
const HomeSidebar: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className="block md:hidden rounded-2xl ring-[0.5px] ring-Light_primary/50 overflow-hidden border-b-1  border-primary">
                ...
                <div className="flex items-stretc bg-white dark:bg-white/5 min-h-[180px] ">
                    ...
                    <div className="relative w-[130px] shrink-0">
                        ...
                        <div className="absolute inset-0 bg-linear-to-r rounded-l-2xl from-primary via-primary to-secondary dark:from-primary/50 dark:via-primary/50 dark:to-primary/50" />
                                ...
                                icons.map((item: SidebarBannerIcon, i: number) => {
                                    ...
                                    return (
                                        <motion.a
                                            ...
                                            className="text-primary ring ring-primary/50  dark:ring-Light_primary p-1 rounded-full  flex items-center justify-center"
                                        >
                                            <Icon size={15} />
                                        </motion.a>
                                    );
            ...
            <div className="hidden md:block relative shadow-lg/5 rounded-3xl p-2 group ring-Light_primary/50 ring-[0.5px] pb-14">
                <div className="absolute top-2 left-2 w-[calc(100%-16px)] h-[calc(45%-16px)] rounded-t-3xl bg-linear-to-r dark:bg-linear-to-l from-primary via-primary to-secondary dark:from-primary/50 dark:via-primary/50 dark:to-primary/50 dark:backdrop-blur-xl dark:border dark:border-white/20 dark:shadow-2xl -z-10" />
                <motion.div
                    initial={{ y: 10 }}
                    whileInView={{ y: 0 }}
                    viewport={{ once: true }}
                ...
                <div className="flex gap-3 -mt-10 bg-linear-to-r from-primary via-primary to-secondary px-2 py-4 justify-center">
                    {icons && icons.length > 0 ? (
                        icons.map((item: SidebarBannerIcon, i: number) => {
                            const { Icon, href } = item;
                            if (!Icon) return null;
