...
const MockupWebsite: React.FC<Props> = ({ data }) => {
    return (
        <>
            <Link href={`/project`} className='w-full z-20 mt-5 grid grid-cols-12 gap-1 bg-transparent shadow-lg/3 px-5 py-8 rounded-2xl ring-1 ring-Light_primary hover:shadow-xl transition-all duration-300 relative'>
